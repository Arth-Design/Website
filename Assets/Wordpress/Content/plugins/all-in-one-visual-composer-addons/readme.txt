...
== Description ==
This plugin contains almost all the addons that are mostly use to build pages.It contains 20+ most using addons for WPBakery Page Builder to build your website in few click.These addons contains very simple and easy settings and new user can easily use it.

Note: This plugin requires <a href="http://codecanyon.net/item/visual-composer-page-builder-for-wordpress/242431?ref=labibahmed" target="_blank"> WPBakery Page Builder</a>.<br>


<h3>Contains Following Addons</h3>

<ul>
	<li><a href="https://demo.webdevocean.com/banners/">Banners</a> - <strong> Create banner with text over image.</strong></li>	 
	<li><a href="https://demo.webdevocean.com/team-vc/">Team Showcase</a> - <strong> Add your team members with animations.</strong></li>
	<li><a href="https://demo.webdevocean.com/team-flip/">Team Flip Box</a> - <strong> Add team members in flip styles with social icons.</strong></li>
	<li><a href="https://demo.webdevocean.com/pricing-tables-vc/">Pricing Tables</a> - <strong> Display pricing with custom options.</strong></li> 
	<li><a href="https://demo.webdevocean.com/image-over-image-vc/">Image Over Image </a> - <strong>Add one image over other with changes on hover.</strong> </li> 
	<li><a href="https://demo.webdevocean.com/text-over-image/">Text Over Image </a> - <strong> Display static text over image with animations.</strong></li> 
	<li><a href="https://demo.webdevocean.com/flip-box/">Flip Box </a> - <strong> Add content in flip book style.</strong> </li> 
	<li><a href="https://webdevocean.com/3d-buttons-visual-composer/">3D Buttons</a> - <strong> Add 3D styled buttons.</strong> </li> 
