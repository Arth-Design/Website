<div class="edgtf-core-dashboard wrap about-wrap">
	<h1 class="edgtf-cd-title"><?php esc_html_e('System Status', 'ratio-core'); ?></h1>
	<h4 class="edgtf-cd-subtitle"><?php esc_html_e('Here is a general overview of your system status', 'ratio-core'); ?></h4>
	<div class="edgtf-core-dashboard-inner">
		<div class="edgtf-core-dashboard-column">
			<div class="edgtf-core-dashboard-box">
				<div class="edgtf-cd-box-title-holder">
					<h2><?php esc_html_e('WordPress Environment', 'ratio-core'); ?></h2>
				</div>
		...
		<div class="edgtf-core-dashboard-column">
			<div class="edgtf-core-dashboard-box">
				<div class="edgtf-cd-box-title-holder">
					<h2><?php esc_html_e('Theme Information', 'ratio-core'); ?></h2>
				</div>
				<div class="edgtf-cd-box-inner">
			...
			<div class="edgtf-core-dashboard-box">
				<div class="edgtf-cd-box-title-holder">
					<h2><?php esc_html_e('Active Plugins', 'ratio-core'); ?><sup>(<?php echo count($plugins); ?>)</sup></h2>
				</div>
				<div class="edgtf-cd-box-inner">
					<?php foreach ($plugins as $plugin_key => $plugin_value): ?>
						<div class="edgtf-cd-box-row">
							...
							<div class="edgtf-cdb-value"><?php esc_html_e('by', 'ratio-core'); ?> <a href="<?php echo esc_url($plugin_value['author_url']); ?>"><?php echo wp_kses_post($plugin_value['author']); ?></a> - <?php echo wp_kses_post($plugin_value['version']); ?></div>
						</div>
					<?php endforeach; ?>
				</div>
			</div>
