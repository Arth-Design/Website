...
if ( ! class_exists( 'RatioCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class RatioCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'ratio-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'ratio_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	RatioCoreDashboardRestAPI::get_instance();
}