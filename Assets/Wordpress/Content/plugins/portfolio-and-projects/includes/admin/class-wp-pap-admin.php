...
class Wp_Pap_Admin {
	...
	function wp_pap_register_menu() {
		...
		// add_submenu_page( 'edit.php?post_type='.WP_PAP_POST_TYPE, __('Upgrade to PRO - Portfolio and Projects', 'portfolio-and-projects'), '<span style="color:#ff2700">'.__('Upgrade to PRO', 'portfolio-and-projects').'</span>', 'manage_options', 'wp-pap-premium', array($this, 'wp_pap_premium_page') );

		add_submenu_page( 'edit.php?post_type='.WP_PAP_POST_TYPE, __('Upgrade To PRO - Portfolio and Projects', 'portfolio-and-projects'), '<span class="wp-pap-upgrade-pro" style="color:#ff2700">' . __('Upgrade To Premium ', 'portfolio-and-projects') . '</span>', 'manage_options', WP_PAP_PLUGIN_LINK_UPGRADE );
		add_submenu_page( 'edit.php?post_type='.WP_PAP_POST_TYPE, __('Bundle Deal - Portfolio and Projects', 'portfolio-and-projects'), '<span class="wp-pap-upgrade-pro" style="color:#ff2700">' . __('Bundle Deal', 'portfolio-and-projects') . '</span>', 'manage_options', WP_PAP_PLUGIN_BUNDLE_LINK );
	}
