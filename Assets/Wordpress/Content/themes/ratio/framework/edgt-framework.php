...
if(!function_exists('ratio_edge_enqueue_admin_scripts')) {
	...
	function ratio_edge_enqueue_admin_scripts() {
		...
		wp_enqueue_media();
		wp_enqueue_script("ratio-edge-dependence", EDGE_ROOT.'/framework/admin/assets/js/edgtf-ui/edgtf-dependence.js', array(), false, true);
        wp_enqueue_script("ratio-edge-twitter-connect", EDGE_ROOT.'/framework/admin/assets/js/edgtf-twitter-connect.js', array(), false, true);
...
if(!function_exists('ratio_edge_enqueue_meta_box_scripts')) {
	...
	function ratio_edge_enqueue_meta_box_scripts() {
		...
		wp_enqueue_script('postbox');
		wp_enqueue_media();
		wp_enqueue_script('ratio-edge-dependence');
...
if(!function_exists('ratio_edge_enqueue_nav_menu_script')) {
	...
	function ratio_edge_enqueue_nav_menu_script($hook) {
		if($hook == 'nav-menus.php') {
			wp_enqueue_script('ratio-edge-nav-menu', EDGE_ROOT.'/framework/admin/assets/js/edgtf-nav-menu.js');
			wp_enqueue_style('ratio-edge-nav-menu', EDGE_ROOT.'/framework/admin/assets/css/edgtf-nav-menu.css');
		}
	}
...
if(!function_exists('ratio_edge_meta_box_add')) {
	...
	function ratio_edge_meta_box_add() {
		...
		foreach ($ratio_edge_Framework->edgtMetaBoxes->metaBoxes as $key=>$box ) {
			...
			if(is_array($box->scope) && count($box->scope)) {
				foreach($box->scope as $screen) {
					ratio_edge_create_meta_box_handler( $box, $key, $screen );
		...
		if ( ratio_edge_is_wp_gutenberg_installed() || ratio_edge_is_gutenberg_installed() ) {
			ratio_edge_enqueue_meta_box_styles();
			ratio_edge_enqueue_meta_box_scripts();
		}else {
