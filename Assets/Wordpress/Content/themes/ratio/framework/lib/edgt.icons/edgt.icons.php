...
class RatioEdgeIconCollections {
    ...
    public function getSocialIconWidgetParamsArray() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title' => esc_html__( 'Icon Pack', 'ratio' ),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome' => esc_html__( 'Font Awesome', 'ratio' ),
                'font_elegant' => esc_html__( 'Font Elegant', 'ratio' ),
                'ion_icons' => esc_html__( 'Ion Icons', 'ratio' ),
                'simple_line_icons' => esc_html__( 'Simple Line Icons', 'ratio' )
            )
        );
        ...
        if(is_array($iconCollectionsVC) && count($iconCollectionsVC)) {
            foreach($iconCollectionsVC as $key => $collection) {
                $iconSetParams[] = array(
                    'type'    => 'dropdown',
                    'title'   => $collection->title. esc_html__( ' Icon', 'ratio' ),
    ...
    public function getIconSizesArray() {
        return array(
            esc_html__( "Tiny", 'ratio' )       => "fa-lg",
            esc_html__( "Small", 'ratio' )      => "fa-2x",
            esc_html__( "Medium", 'ratio' )     => "fa-3x",
            esc_html__( "Large", 'ratio' )      => "fa-4x",
            esc_html__( "Very Large", 'ratio' ) => "fa-5x"
        );
    }
    ...
    public function enqueueStyles() {
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $collection_key => $collection_obj) {
                wp_enqueue_style('ratio-edge-'.$collection_key, $collection_obj->styleUrl);
            }
        }
    }
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
	            ...
	            echo ratio_edge_get_module_part( $iconsObject->getSearchIcon() );
            }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
	            ...
	            echo ratio_edge_get_module_part( $iconsObject->getSearchClose() );
            }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
	        echo ratio_edge_get_module_part( $iconsObject->getSearchIconValue() );
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
	        echo ratio_edge_get_module_part( $iconsObject->getMenuSideIcon() );
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
	        echo ratio_edge_get_module_part( $iconsObject->getBackToTopIcon() );
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
	            ...
	            echo ratio_edge_get_module_part( $iconsObject->getMobileMenuIcon() );
            }
        }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
	            ...
	            echo ratio_edge_get_module_part( $iconsObject->getQuoteIcon() );
            }
