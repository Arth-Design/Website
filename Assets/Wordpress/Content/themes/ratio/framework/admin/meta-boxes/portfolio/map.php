...
$edgtAdditionalSidebarItems = ratio_edge_create_meta_box(
    array(
        'scope' => array('portfolio-item'),
        'title' => esc_html__( 'Additional Portfolio Sidebar Items', 'ratio' ),
	...
	$edgt_portfolio_properties = ratio_edge_add_options_framework(
	    array(
	        'label' => esc_html__( 'Portfolio Properties', 'ratio' ),
...
$edgtSecondPortfolioFeaturedImage =  ratio_edge_create_meta_box(array(
	'scope' => array('portfolio-item'),
	'title' => esc_html__( 'Second Featured image', 'ratio' ),
...
ratio_edge_create_meta_box_field(
	array(
		...
		'type'        	=> 'image',
		'label'       	=> '',
		'description' => esc_html__( 'Only for Row and Scrollable Portfolio List Types', 'ratio' ),
...
$edgtThirdPortfolioFeaturedImage = ratio_edge_create_meta_box(array(
	'scope' => array('portfolio-item'),
	'title' => esc_html__( 'Third Featured image', 'ratio' ),
